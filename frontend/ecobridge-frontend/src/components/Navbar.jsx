...
export default function Navbar({ currentStep, goHome, goLogin }) {
  ...
  <>
    ...
    <li
      ...
      className="bg-red-600 px-4 py-1 rounded-lg hover:bg-red-500 transition cursor-pointer"
    >
      Logout
    </li>
  </>
...
<motion.li
  ...
  className="bg-green-600 px-6 py-2 rounded-lg hover:bg-green-500 cursor-pointer"
>
  Login
</motion.li>
...
<motion.li
  ...
  className="bg-red-600 px-6 py-2 rounded-lg hover:bg-red-500 cursor-pointer"
>
  Logout
</motion.li>
