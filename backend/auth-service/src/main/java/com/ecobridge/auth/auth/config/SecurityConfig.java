...
//This setup makes it very easy to protect individual operations, such as ensuring that only an Admin can trigger a deleteUser or getUserById method, regardless of the API route
